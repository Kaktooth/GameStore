...
public class MAEMetric implements UserMetric {
  ...
  public CalculatedMetric calculateMetric(UUID userId) {
    ...
    if (MAE.isNaN()) {
      ...
      calculatedMetric = new CalculatedMetric(UUID.randomUUID(), userId, BigDecimal.valueOf(MAE),
          metricName, "",
          MetricType.USER);
    }
